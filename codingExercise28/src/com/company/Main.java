...
//Bob is a wall painter and he needs your help. You have to write a program that helps Bob calculate how many buckets of paint he needs
...
//        scanner.close();
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets ) {
        if (width >0 &&  height >0 && areaPerBucket > 0  && extraBuckets >=0){
            ...
            double preArea = areaPerBucket * extraBuckets;
            double areaRemain = area - preArea;
            return (int) Math.ceil(areaRemain/areaPerBucket);
